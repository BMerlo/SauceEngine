...
public:
	...
	MeshData CreateCandy1(float width, float height, float depth, uint32 numSubdivisions);
	MeshData CreateBox1(uint32 numSubdivisions);
	MeshData CreateBox2(float width, float height, float depth, uint32 numSubdivisions);
	MeshData CreateBox3(uint32 numSubdivisions);
	MeshData CreateCandy2(uint32 numSubdivisions);
	MeshData CreateCandy3(uint32 numSubdivisions);

	DirectX::XMVECTOR ComputeNormal(DirectX::XMVECTOR pO, DirectX::XMVECTOR pl, DirectX::XMVECTOR p2);
